...
abstract class DioMedule {
  ...
  @singleton
  @injectable
  SubcategoryWebService provideSubcategoryWebService(Dio dio) =>
      SubcategoryWebService(dio);

  @singleton
  @injectable
  PaymentWebService providePaymentWebService(Dio dio) => PaymentWebService(dio);
}
